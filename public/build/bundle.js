    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$1, 21, 4, 463);
    			add_location(span1, file$1, 22, 4, 494);
    			attr_dev(div, "class", "header svelte-edsntc");
    			add_location(div, file$1, 20, 0, 437);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text("\n\t\n\tsample text");
    			attr_dev(div, "class", "container svelte-1gpndtu");
    			add_location(div, file, 15, 0, 193);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
